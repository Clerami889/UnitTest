...
import com.clerami.intermediate.ui.story.StoryAdapter
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val expectedQuote: Flow<PagingData<ListStoryItem>> = flowOf(data)
        ...
        val actualQuote = mainViewModel.stories.getOrAwaitValue()
